...
import { downloadMCPExport } from '../api/client';
      ...
      <div style={styles.modal} onClick={e => e.stopPropagation()}>
        ...
        <div style={styles.content}>
          ...
          <div style={styles.section}>
            ...
            {(mcp.tools || []).map(tool => (
              <div key={tool.name}>
                ...
                {/* Test Panel - shows when tool is selected */}
          ...
          <div style={styles.section}>
            ...
            <div style={styles.runLocally}>
              <div style={styles.runLocallyLabel}>Run locally:</div>
              <code style={styles.runLocallyCode}>
                pip install -r requirements.txt && python {mcp.hasServerPy ? 'server.py' : 'mcp_server.py'}
              </code>
            </div>
          </div>
        </div>
