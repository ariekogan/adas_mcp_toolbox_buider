      ...
      phases: [
        ...
        },
        {
          ...
          tips: [
            ...
            'For production deployments: use ateam_github_list_versions to see all dev versions, then ateam_github_promote to move tested version to main',
            'Version management: every deployment auto-pushes to dev branch with date-based tags (dev-YYYY-MM-DD-NNN), keep last 10 versions',
            'Safety: use ateam_github_rollback (requires confirm:true) to revert to previous production version if needed',
          ],
        },
      ],
      completeness_fields: [
