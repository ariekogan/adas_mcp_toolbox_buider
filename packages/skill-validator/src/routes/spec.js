...
function buildSolutionSpec() {
  return {
    ...
    schema: {
      ...
      // 1. DURING DEPLOYMENT: ateam_build_and_run stores plugin bundles in Core MongoDB
      // 2. IN CORE API: GET /api/solutions/{solutionId}/ui-plugins/{pluginId}/bundle.js
      ...
      //    - Falls back to pre-bundled registry if remote unavailable
      ...
      //           "bundleUrl": "https://core.ateam.com/api/solutions/ecommerce/ui-plugins/order-dashboard/bundle.js"  // ← Auto-set
      //         }
      //       }
      //     }
      //   ]
      ...
      ui_plugins: {
        ...
        key_concepts: {
          ...
          'bundle_serving': 'React Native plugin bundles are served by Core API. System auto-generates bundleUrl during deployment. Mobile app downloads, caches locally (7-day TTL), and loads from cache. No separate CDN needed.',
          'mobile_bundle_flow': '1. ateam_build_and_run stores bundle in Core 2. Core API serves via /api/solutions/{id}/ui-plugins/{id}/bundle.js 3. Mobile app fetches and caches 4. Next load is instant from cache',
          ...
          render: {
            ...
            fields: {
              ...
              reactNative: {
                ...
                fields: {
                  component: { type: 'string', required: true, description: 'Component name (must match PluginSDK.register(name, {...}) or pre-bundled registry)' },
                  bundleUrl: { type: 'string', required: false, description: 'Auto-generated by Core during deployment. URL to fetch React Native bundle: /api/solutions/{solutionId}/ui-plugins/{pluginId}/bundle.js. Mobile app caches locally (7-day TTL).' },
